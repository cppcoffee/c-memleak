...
use c_memleak::util::{dump_to_file, get_binary_path_by_pid};
use c_memleak_common::AllocInfo;
...
async fn dump_stack_frames(ebpf: &mut Ebpf, pid: pid_t) -> Result<HashMap<String, usize>> {
    let mut count = 0;
